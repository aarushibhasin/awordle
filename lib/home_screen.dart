  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.title,style: mainButtonTextStyle),
      ),
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Image.asset('assets/img/wordle_icon.png',width: 150,
                height: 150,
                fit:BoxFit.fill  ),
            SizedBox(height: 50,),
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('Start A New Game', style: mainButtonTextStyle),
              ),),
            SizedBox(height: 30,),
            ...
            //     style: raisedButtonStyle,
            //     onPressed: () { },
            //     child: Text('Resume Game', style: mainButtonTextStyle,),
            //   ),),
